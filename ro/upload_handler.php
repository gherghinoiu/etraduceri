...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->Password   = 'Aioani_60603010';                   // IMPORTANT: SMTP password for contact@traduceri.eu
    ...
    // 3. Redirecționează utilizatorul înapoi la pagina de unde a venit
    ...
    // În caz că nu este o cerere POST
    header('Location: comanda-online.php');
    exit();
}
/*
