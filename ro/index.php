...
<!-- Mirrored from traduceriautorizat.com/index.php/ro/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Jul 2025 05:06:55 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <title>Acasă - Laseda Services</title>
  <link href="../en/index.html" rel="alternate" hreflang="en-GB">
  <link href="index.html" rel="alternate" hreflang="ro-RO">
  ...
  <link href="../media/t4/css/12-108.css" rel="stylesheet" />
...
<body class="site-default navigation-ro theme-default layout-home nav-breakpoint-lg com_content view-article item-108" data-jver="4">
                  ...
                  <div class="module-inner">
                    <div class="module-ct col-md-8">
                      <div class="mod-languages">
                        <p class="visually-hidden" id="language_picker_des_119">Selectați limba dvs</p>
                        ...
                        <!--  <ul aria-labelledby="language_picker_des_119" class="mod-languages__list lang-inline">
                          ...
                          <li class="lang-active">
                            <a aria-current="true" href="index.html">
                  ...
                  <nav class="navbar navbar-expand-lg">
                    ...
                    <div id="t4-megamenu-mainmenu-ro-ro" class="t4-megamenu collapse navbar-collapse">
                      ...
                      <ul class="nav navbar-nav level0" itemscope="itemscope" itemtype="http://www.schema.org/SiteNavigationElement">
                        ...
                        <li class="nav-item" data-id="116" itemprop="name" data-level="1"><a href="preturi.html" class="nav-link">Prețuri</a></li>
                        <li class="nav-item dropdown parent" data-id="117" itemprop="name" data-level="1"><a href="servicii.html" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown">Servicii<i class="item-caret"></i></a>
                          <div class="dropdown-menu level1" data-bs-popper="static">
                            <div class="dropdown-menu-inner">
                              <ul>
                                <li class="nav-item" data-id="121" itemprop="name" data-level="2"><a href="servicii/licitatii-si-proiecte-cu-finantare-europeana.html" class="dropdown-item">Licitații și proiecte cu finanțare europeană</a></li>
                                <li class="nav-item" data-id="122" itemprop="name" data-level="2"><a href="servicii/traduceri-specializate.html" class="dropdown-item">Traduceri specializate</a></li>
                                <li class="nav-item" data-id="123" itemprop="name" data-level="2"><a href="servicii/servicii-pentru-companii.html" class="dropdown-item">Servicii pentru companii</a></li>
                              </ul>
                            </div>
                          </div>
                        </li>
                        <li class="nav-item" data-id="118" itemprop="name" data-level="1"><a href="intrebari-frecvente.html" class="nav-link">Întrebări frecvente</a></li>
                        <li class="nav-item" data-id="119" itemprop="name" data-level="1"><a href="contact.html" class="nav-link">Contact</a></li>
                        <li class="nav-item" data-id="120" itemprop="name" data-level="1"><a href="comanda-online.php" class="nav-link">Comandă</a></li>
                      </ul>
                    </div>
                  </nav>
                ...
                <div id="acm-hero-112" class="acm-hero style-1 text-left  show-intro">
                  ...
                  <div class="hero-content">
                    ...
                    <p class="lead hero-intro animated delay-1s" data-animated-type="fadeInRight">
                      Oferim servicii profesionale de traducere autorizată și legalizată, revizie și interpretariat în peste 20 de limbi de circulație internațională, în regim normal și în regim de urgență, inclusiv în weekend sau sărbători legale. </p>

                    <div class="hero-btn-actions animated delay-2s" data-animated-type="fadeInRight">
                      <a class="btn btn-lg btn-secondary" href="comanda-online.php" title="Comandă acum">
                  ...
                  <div id="acm-hero-128" class="acm-hero style-2 text-right ">
                    <div class="row">
                      ...
                      <div class="hero-content col-md-6">
                        ...
                        <img class="hero-img" src="../images/stampila.png#joomlaImage://local-images/stampila.png?width=430&amp;height=434" alt="" />
